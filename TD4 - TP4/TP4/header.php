<?php
    ...
    if (isset($_SESSION['civ']) && ($_SESSION['nom']) && ($_SESSION['prenom'])) {
    echo "<header>";
 echo '<h1><a href="index.php">Bienvenue sur SiteWebShop !</a></h1>';
 echo '<nav id="menu"><ul><li>Bonjour '.$_SESSION['civ'].' '.$_SESSION['nom'].' '.$_SESSION['prenom'].'</li><li><a href="deconnexion.php">déconnexion</a></li><li><a href="index.php">accueil</a></li><li><a href="login.php">login</a></li><li><a href="creer_compte.php">créer compte</a></li><li><a href="panier.php">panier</a></li></ul></nav>';
